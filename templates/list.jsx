              ...
              <div className="list-item__inner">
                ...
                <div className="list-item__content">
                  {title &&
                    ...
                    >
                      <div className="list-item__title-inner" dangerouslySetInnerHTML={{ __html: compile(title) }} />
                    </div>
                  }

                  {body &&
                    <div className="list-item__body">
                      <div className="list-item__body-inner" dangerouslySetInnerHTML={{ __html: compile(body) }} />
                    </div>
                  }
                </div>
